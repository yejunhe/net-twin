...
class NodeReader:
    ...
    def evaluate_performance(self):
        ...
        memory_overload = any(float(container["memory_usage"].split('/')[0].rstrip('MiB').strip()) > 80 for container in self.output_data["containers"] if container["memory_usage"] != 'N/A')
