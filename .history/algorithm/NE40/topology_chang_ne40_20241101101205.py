...
class CombinedScriptManager:
    ...
    def run(self):
        ...
        # 运行拓扑变更检测
        detector_output_path = os.path.join(output_dir, "topology_change_report.txt")
        topology_detector = TopologyChangeDetector(self.input_path, detector_output_path)
        topology_detector.run()
