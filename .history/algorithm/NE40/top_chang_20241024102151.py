...
class RouterManager:
    def __init__(self, telnet_info: Dict[str, Any], max_workers: int = 20):
        ...
        self.unl_file_content: Optional[str] = None
        self.network_topology: Optional[Dict[str, Any]] = None
    ...
    def collect_results(self) -> Dict[str, Any]:
        return {
            ...
            "unl_file_content": self.unl_file_content,
    ...
    def read_unl_file(self, lab_id: int):
        ...
        try:
            with open(unl_file_path, 'r') as f:
                self.unl_file_content = f.read()
            logging.info(f"Successfully read UNL file from {unl_file_path}")
            self.parse_unl_file(self.unl_file_content)
    ...
    def parse_unl_file(self, unl_content: str):
        try:
            ...
            topology = {"nodes": [], "networks": [], "connections": []}
            ...
            for network in root.findall(".//network"):
                ...
                networks[network_id] = network_info
            ...
            logging.info(f"Successfully parsed UNL file into network topology.")
