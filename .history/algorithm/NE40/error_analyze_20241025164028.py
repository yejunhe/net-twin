...
def main(input_path: str, output_path: str):
    ...
    for host_port, output in router_manager.isis_outputs.items():
        if output:  # 仅对有ISIS输出的设备进行检测
            try:
                ...
                logging.error(f"Failed to connect to {host_port} for ISIS detection: {e}")
        else:
    ...
    report_generator = ReportGenerator(sysname_map, ospf_faults, isis_faults, bgp_faults, acl_errors, network_impacts, optimization_suggestions)
