...
class RouterManager:
    ...
    def execute_tracert(self, tn: telnetlib.Telnet, dest_ip: str) -> Tuple[Optional[str], str]:
        ...
        try:
            ...
            timeout = 60  # Increased Maximum wait time for tracert to complete
