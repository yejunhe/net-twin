...
class RouterManager:
    ...
    def parse_display_ip_interface_brief(self, output: str) -> List[Dict[str, str]]:
        ...
        interface_regex = re.compile(
            ...
            r'(?P<physical>up|down|\*down|!down|\^down|\(l\)|\(s\)|\(d\)|\(E\))\s+'
    ...
    def collect_results(self) -> Dict[str, Any]:
        ...
        sysname_to_host_port = {info["sysname"]: host_port for host_port, info in self.telnet_sysnames.items()}
...
def write_interface_status(data_txt_path: str, mapping: Dict[str, Any]):
    ...
    try:
        with open(data_txt_path, 'w', encoding='utf-8') as f:
            ...
            sysname_to_host_port = {info["sysname"]: host_port for host_port, info in telnet_devices.items()}
