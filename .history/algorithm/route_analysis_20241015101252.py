...
class RouterManager:
    ...
    def connect_via_docker(self, docker_id):
        ...
        # 获取容器名称对应的 CONTAINER ID
            ...
            print(f"Docker command output for sysname detection:\n{output}")
            ...
            print(f"Docker command output after sysname:\n{output}")
    ...
    def extract_sysname_from_docker_output(self, output):
        ...
        假设 sysname 以类似于 'FR2# terminal length 0' 的格式显示，其中 'FR2' 是 sysname。
        """
        try:
            sysname = None
            lines = output.splitlines()
                ...
                if '#' in line:
                    ...
                    if len(parts) >= 2:
                        ...
                        if sysname_candidate:
                            ...
                            print(f"Extracted sysname from line: {sysname}")  # 调试信息
                            break
