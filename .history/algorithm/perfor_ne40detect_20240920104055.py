...
class RouterTelnetManager:
    ...
    def parse_nqa_result(self, nqa_result):
        ...
        for line in nqa_result.splitlines():
            ...
            if rtt_match:
                try:
                    latency_avg = float(rtt_match.group(3))  # Average RTT is the 3rd capture group
