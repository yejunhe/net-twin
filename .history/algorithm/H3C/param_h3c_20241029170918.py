...
class RouterManager:
    ...
    def parse_display_bgp_peer_ipv4(self, output: str) -> Dict[str, Any]:
        ...
        if bgp_info['local_router_id'] and bgp_info['local_as_number']:
            logging.info(f"提取到本地 BGP Router ID: {bgp_info['local_router_id']}，AS Number: {bgp_info['local_as_number']}，总 Peers: {bgp_info['total_peers']}，建立状态的 Peers: {bgp_info['established_peers']}")
