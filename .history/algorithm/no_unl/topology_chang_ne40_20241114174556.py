...
class RouterManager:
    def __init__(self, telnet_info: Dict[str, Any], max_workers: int = 20):
        ...
        # Dictionaries to store sysnames and filtered routing tables
    ...
    def collect_results(self) -> Dict[str, Any]:
        return {
            "telnet_devices": {
                ...
                for host_port in self.telnet_filtered_routing_tables
            }
        }
...
def write_output(output_path: str, data: Dict[str, Any]):
    try:
        ...
        logging.info(f"Filtered routing results with sysnames written to {output_path}")
    except IOError as e:
...
def main(input_path: str, output_path: str):
    ...
    logging.info("Collected filtered routing configurations with sysnames:")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", required=True, help="Output path for filtered routing information with sysnames, use {t} for latest folder number.")
