...
class RouterManager:
    ...
    def collect_results(self) -> Dict[str, Any]:
        ...
        mapping = {
            ...
            # "as_boundary_router_count": as_boundary_router_count,  # 移除自治域边界路由器统计
            "total_nodes": len(self.telnet_sysnames),  # Total number of nodes
            # "evaluation_per_as": {},  # 移除评估
    ...
    def write_interface_status(self, data_txt_path: str, mapping: Dict[str, Any]):
        ...
        try:
            with open(data_txt_path, 'w', encoding='utf-8') as f:
                ...
                # as_boundary_router_count = mapping.get("as_boundary_router_count", {})  # 移除
                # evaluation_per_as = mapping.get("evaluation_per_as", {})  # 移除
